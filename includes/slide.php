...
class Slide extends databaseObject
{
    ...
    protected static $db_fields = array('id','filename','type','size','caption','url');
    ...
    private $temp_path;
    protected $upload_dir= "slider_img";
    ...
    public function save()
    {
        ...
        if(isset ($this->id))
        {
            //just updating the record means only update the caption or description
            $this->update();
        }
        else
        {
            ...
            //if the caption is too long to hold in DB table
            if(strlen($this->caption)> 255)
            {
                $this->errors[]="caption can't be too long than 255 characters. File Upload Failed";
                return false;
            }
